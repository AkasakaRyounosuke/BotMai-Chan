...
/////////////////
const BotName = 'MAI-CHAN BOT☄'; 
const instagram = 'https://instagram.com/erj.117'; 
...
conn.on('user-presence-update', json => console.log(json.id + ' presence is => ' + json.type)) || console.log('Bot by ig:@erj.117')
